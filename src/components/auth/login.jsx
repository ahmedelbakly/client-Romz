...
const SignIn = () => {
  ...
  const isTwoFactor = localStorage.getItem("isTwoFactor");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.message === "Two factor authentication is required") {
        localStorage.setItem("isTwoFactor", true);
        localStorage.setItem("userId", response.data.data);

         toast("Two factor authentication is required", { type: "info" });
